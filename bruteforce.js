...
// prettier-ignore
const testTpl = {"watch":{"exchange":"poloniex","currency":"USDT","asset":"XRP"},"paperTrader":{"feeMaker":0.25,"feeTaker":0.25,"feeUsing":"maker","slippage":0.05,"simulationBalance":{"asset":1,"currency":100},"reportRoundtrips":true,"enabled":true},"tradingAdvisor":{"enabled":true,"method":"DEMA","candleSize":5,"historySize":100},"DEMA":{"weight":21,"thresholds":{"down":0,"up":0.03}},"backtest":{"daterange":{"from":"2018-09-01T00:00:00Z","to":"2018-10-01T00:00:00Z"}},"backtestResultExporter":{"enabled":true,"writeToDisk":false,"data":{"stratUpdates":false,"roundtrips":true,"stratCandles":true,"stratCandleProps":["open"],"trades":true}},"performanceAnalyzer":{"riskFreeReturn":2,"enabled":true},"valid":true}
...
function evalBalanceTrades(result) {
  return (
    result.performanceReport.balance * 1000 + result.performanceReport.trades
  )
}
